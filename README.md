...
The FNR switch has three states, and each line is pulled high using an internal pullup resistor in the power distro board microcontroller. This means that the logic is inverted (if a line is driven low, it is activated).
